...
public class MainFrame extends Application {
    ...
    public void start(final Stage defaultStage) {
        ...
        defaultStage.setHeight(Toolkit.getDefaultToolkit().getScreenSize().getHeight() * SCREEN_H_PERC);
        defaultStage.setWidth(Toolkit.getDefaultToolkit().getScreenSize().getWidth() * SCREEN_W_PERC);
